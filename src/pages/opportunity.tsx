        ...
        <div className="bg-slate-100">
            ...
            <div className=" w-full flex  flex-col pb-4 bg-white shadow-md ">
                ...
                <div className="flex w-11/12 self-center justify-self-center gap-2 ">
                 <div data-tooltip-id="tooltip-2" data-tooltip-content="Lead" className="flex h-8 cursor-pointer w-full"><div className="triangle-right-title-white absolute" ></div><div className="w-full h-full bg-green-500 flex items-center justify-center text-white font-semibold"> {daysInSteps.lead ? daysInSteps.lead + " Dias" : "" }  </div><div className="triangle-right-title-green " ></div></div>
                 <div data-tooltip-id="tooltip-2" data-tooltip-content="Contato" className="flex h-8 cursor-pointer w-full"> <div className="triangle-right-title-white absolute" ></div> <div className={`w-full ${daysInSteps.contato || daysInSteps.diagnostico || daysInSteps.teste || daysInSteps.negociacao ? "bg-green-500" : " bg-custom-gray "} flex items-center justify-center text-white font-semibold`}> {daysInSteps.contato ? daysInSteps.contato + " Dias" : "" } </div><div className={`triangle-right-title-${daysInSteps.contato || daysInSteps.diagnostico || daysInSteps.teste || daysInSteps.negociacao ? "green" : "grey"}`} ></div></div>
                 ...
                 <div data-tooltip-id="tooltip-2" data-tooltip-content="Negociação" className="flex h-8 cursor-pointer w-full"> <div className="triangle-right-title-white absolute" ></div> <div className={`w-full ${daysInSteps.negociacao ? "bg-green-500" : "bg-custom-gray"} flex items-center justify-center text-white font-semibold`}> { daysInSteps.negociacao ? daysInSteps.negociacao + " Dias" : "" } </div><div className={`triangle-right-title-${daysInSteps.negociacao ? "green" : "grey"}`} >  </div></div>
                 </div>
                }
            </div>
